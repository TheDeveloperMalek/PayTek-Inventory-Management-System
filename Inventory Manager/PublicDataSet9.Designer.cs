...
namespace Inventory_Manager {
    ...
    public partial class PublicDataSet9 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/PublicDataSet9.xsd";
        ...
        public partial class PurchaseDataTable : global::System.Data.TypedTableBase<PurchaseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PurchaseRow AddPurchaseRow(int id, int customer_id, string customer_name, int product_id, string product_name, int quantity, int total_price) {
        ...
        public partial class PurchaseRow : global::System.Data.DataRow {
            ...
            public int total_price {
                get {
                    try {
                        return ((int)(this[this.tablePurchase.total_priceColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Inventory_Manager.PublicDataSet9TableAdapters {
    ...
    public partial class PurchaseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Purchase] ([id], [customer_id], [customer_name], [product_id]," +
                " [product_name], [quantity], [total_price]) VALUES (@id, @customer_id, @customer" +
                "_name, @product_id, @product_name, @quantity, @total_price)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, customer_id, customer_name, product_id, product_name, quantity, total_" +
                "price FROM dbo.Purchase";
        ...
        public virtual int Insert(int id, int customer_id, string customer_name, int product_id, string product_name, global::System.Nullable<int> quantity, global::System.Nullable<int> total_price) {
