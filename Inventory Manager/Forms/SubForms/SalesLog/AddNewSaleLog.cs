...
{
    public partial class AddNewSaleLog : Form
    {

        #region Essential data
        readonly SalesLog callerForm;

        public AddNewSaleLog(SalesLog c)
        {
            InitializeComponent();
                    ...
                    try
                    {
                        using (SqlCommand cmd = new SqlCommand("", Shared.conn))
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    cmd.Parameters.AddWithValue("@product_name", ProductNameTextBox.Text);
                                    cmd.CommandText = "AddNewSaleLogByCustomerNameAndProductName";
                                }

                                else if (ProductIdTextBox.Text != "")
                                {
                                    cmd.Parameters.AddWithValue("@product_id", ProductIdTextBox.Text);
                                    cmd.CommandText = "AddNewSaleLogByCustomerNameAndProductID";
                                ...
                                {
                                    cmd.Parameters.AddWithValue("@product_barcode", ProductBarcodeTextBox.Text);
                                    cmd.CommandText = "AddNewSaleLogByCustomerNameAndProductBarcode";
                                }
                            }
                            cmd.ExecuteNonQuery();
